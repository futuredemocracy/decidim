    ...
    module Sms
      class AuthorizationsController < ApplicationController
        ...
        def update
          ...
          if authorization.failed_attempts >= 3
            flash.now[:alert] = t("sms.authorizations.update.too_many_attempts")
            return render :edit
          end
          ...
          ConfirmUserAuthorization.call(authorization, @form, session) do
            ...
            on(:invalid) do
              authorization.increment!(:failed_attempts)
        ...
        def destroy
          ...
          if authorization.created_at < 10.minutes.ago
            authorization.destroy!
            flash[:notice] = t("authorizations.destroy.success", scope: "decidim.verifications.sms")
            redirect_to action: :new
          else
            flash.now[:alert] = t("sms.authorizations.destroy.too_early")
            @form = ConfirmationForm.from_params(params)
            render :edit
          end
        end
